...
#LN_BOCO -Nulled Nulled_intemp.nii -BOLD BOLD_intemp.nii -output VASO_LN.nii # output file name became VASO_LN_VASO_LN.nii
#3dcopy VASO_LN_VASO_LN.nii VASO_LN.nii
